...
/**
 * POST /api/guest/products/scrape
 *
 * Scrape product metadata from a URL (for guest users)
 * This endpoint doesn't require authentication but has rate limiting
 *
 * Body:
...
export async function POST(request: NextRequest) {
  try {
    ...
    logger.error("Guest URL scrape error", error);
